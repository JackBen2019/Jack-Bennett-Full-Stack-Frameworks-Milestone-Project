...
from .views import index, get_forum, forum_post_details, \
    create_forum_post, edit_forum_post, gen_discussion, events, \
    privacy_policy, change_password, logout, login, registration, \
    about, profile, profile_no_orders, edit_profile, comment_post_form
