...
- [Dennis Ivy](https://www.youtube.com/playlist?list=PL-51WBLyFTg2vW-_6XBoUpE7vpmoR3ztO) - A massive thanks to Dennis Ivy and his Django tutorials, which helped me to create a profile and cart page.
- [Max Goodridge](https://www.youtube.com/playlist?list=PLw02n0FEB3E3VSHjyYMcFadtQORvl1Ssj) - Thanks to Max Goodridge and his tutorial on updating user details from the profile page (including password changes) and adding customer orders to the profile page.
...
- Credit to the Code Institue Slack community and support team for helping to resolve a number of website functionality issues.
- Credit to the Full Stack Frameworks learning module which helped me to acheive a number of features on my website.
